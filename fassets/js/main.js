...
function user_register(){
  ...
  if(name==""){
    ...
    jQuery('#hna_error').html('Please enter your house name');
    is_error='yes';
  } if(city==""){
  ...
  if(is_error==''){
    jQuery.ajax({
      ...
      type:'post',
      data:'c_name='+name+'&c_hna='+hna+'&c_city='+city+'&c_email='+email+'&c_mob='+mobile+'&password='+password,
      success:function(result){
        alert(result);
...
function user_login(){
  ...
  if(is_error==''){
    jQuery.ajax({
      ...
      type:'post',
      data:'c_email='+login_email+'&password='+login_password,
      success:function(result){
      if (result=='wrong') {
