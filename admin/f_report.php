...
/*	if(!$res)
	...
	if($check>0){
     ...
     header("location:finance_report.php?from=$from&to=$to");
...
">
                        ...
                        <form method="post">
						   ...
						   <a href="finance_report.php?all=1"><button id="payment-button" name="all" type="submit" class="btn btn-lg btn-info btn-block">
