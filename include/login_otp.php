<?php
  ...
  if(isset($_POST['phone'])){
    ...
    $msg=$otp." is the one time password for pesfields.com. rate your experience with pesfields here http://bit.ly/2u3Q6qp";
    $to=$_POST['phone'];
    $auth_key='274503ALcRgQbdG55e2e020aP1';
        ...
        curl_setopt_array($curl, array(
          ...
          CURLOPT_POSTFIELDS => "{ \"sender\": \"PSFLDS\", \"route\": \"4\", \"country\": \"91\", \"sms\": [ { \"message\": \"".$msg."\", \"to\": [ \"".$to."\", \"\" ] } ] }",
